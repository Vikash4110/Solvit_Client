              ...
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mb-4">
                    <div className="flex flex-wrap gap-2">
                      {counselor.specialization.slice(0, 3).map((spec) => (
                        <span 
                          key={spec} 
                          className="px-3 py-1 bg-gradient-to-r from-indigo-100 to-indigo-200 text-indigo-800 text-xs rounded-full font-medium shadow-sm"
                        >
                          {spec}
                        </span>
                      ))}
                  ...
                  <div className="flex gap-2">
                    <motion.button
                      onClick={() => handleOpenChat(counselor)}
                      className="flex-1 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-lg flex items-center justify-center gap-2 text-sm"
                      whileHover={{ scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
                      <FaPaperPlane /> Message
                          ...
                          <div className="flex items-center justify-end mt-1">
                            ...
                            {msg.senderId === user._id && (
                              <span className="ml-1">
                                {msg.status === "sent" && <FaCheck className="text-white text-opacity-70" size={10} />}
                                {msg.status === "delivered" && <FaCheckDouble className="text-white text-opacity-70" size={10} />}
                                {msg.status === "seen" && <FaCheckDouble className="text-indigo-200" size={10} />}
                              </span>
                            )}
                          </div>
                        </div>
