          ...
          <div className="flex flex-col gap-6">
            <div className="relative">
              <input
                ...
                value={searchTerm}
                onChange={(e) => setSearchTerm(e.target.value)}
                className="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-transparent text-lg"
              />
              <FaSearch className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400 text-xl" />
            </div>
                    ...
                    >
                      <div className="p-6">
                        ...
                        <div className="mb-4">
                          <div className="flex flex-wrap gap-2">
                            {counselor.specialization.slice(0, 3).map((spec) => (
                              <span key={spec} className="px-3 py-1 bg-indigo-100 text-indigo-800 text-xs rounded-full font-medium">
                                {spec}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-3 mb-4">
                          ...
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                            <IoLanguage className="text-indigo-600" />
                            <span>{counselor.languages.slice(0, 2).join(", ")}</span>
                          </div>
                          <div className="flex items-center gap-2 text-sm text-gray-600">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {counselor.preferredSessionMode.map((mode) => (
                              <span key={mode} className="px-2 py-1 bg-gray-100 text-gray-700 text-xs rounded-full flex items-center gap-1">
                                {mode === "Video Call" && <FaVideo className="text-indigo-600" />}
                                {mode === "Chat" && <FaComments className="text-indigo-600" />}
                                {mode === "Audio Call" && <FaUserFriends className="text-indigo-600" />}
                                {mode}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="flex gap-3">
                          <button
                            onClick={() => navigate(`/counselor-profile/${counselor._id}`)}
                            className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-white py-2 px-4 rounded-lg transition-colors text-center font-medium text-sm"
                          >
                            View Profile
                          </button>
                          {isRequestSent ? (
