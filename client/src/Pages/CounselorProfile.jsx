  ...
  if (isLoading) {
    return (
      <motion.div
        ...
        transition={{ duration: 0.5 }}
      >
        <RotatingLines strokeColor="#4f46e5" strokeWidth="5" animationDuration="0.75" width="48" visible={true} />
      </motion.div>
    );
  }
    ...
    switch (activeTab) {
      case "overview":
        return (
          <div className="space-y-8">
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="visible">
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <FontAwesomeIcon icon={faUser} className="text-indigo-600" /> Personal Information
              </h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-gray-700 bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                <p className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faVenusMars} className="text-indigo-600 w-5" />
                  <span className="font-medium">Gender:</span> {user.gender || "N/A"}
                </p>
                <p className="flex items-center gap-3">
                  <FontAwesomeIcon icon={faCalendarAlt} className="text-indigo-600 w-5" />
                  <span className="font-medium">DOB:</span> {user.dob ? new Date(user.dob).toLocaleDateString() : "N/A"}
                </p>
                <p className="md:col-span-2 flex items-start gap-3">
                  <FontAwesomeIcon icon={faMapMarkerAlt} className="text-indigo-600 w-5 mt-1" />
                  <span className="font-medium">Address:</span>{" "}
                  {user.address
                    ? `${user.address.street}, ${user.address.city}, ${user.address.state} - ${user.address.postalCode}`
                    : "Not provided"}
            ...
            {user.bio && (
              <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.1 }}>
                <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                  <FontAwesomeIcon icon={faBriefcase} className="text-indigo-600" /> Professional Summary
                </h3>
                <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                  <p className="text-gray-700 leading-relaxed">{user.bio}</p>
                </div>
              </motion.div>
            )}
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.2 }}>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <FontAwesomeIcon icon={faStar} className="text-indigo-600" /> Expertise
              </h3>
              <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
                      <FontAwesomeIcon icon={faGraduationCap} className="text-indigo-600" /> Qualifications
                    </h4>
                    <ul className="space-y-2">
                      <li className="flex items-start gap-2">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
                      <FontAwesomeIcon icon={faCheckSquare} className="text-indigo-600" /> Specializations
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {user.specialization?.length > 0 ? (
                        user.specialization.map((spec, index) => (
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
                      <FontAwesomeIcon icon={faBriefcase} className="text-indigo-600" /> Experience
                    </h4>
                    <p className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="font-medium text-gray-800 mb-3 flex items-center gap-2">
                      <FontAwesomeIcon icon={faLanguage} className="text-indigo-600" /> Languages
                    </h4>
                    <div className="flex flex-wrap gap-2">
                      {user.languages?.length > 0 ? (
                        user.languages.map((lang, index) => (
      ...
      case "professional":
        return (
          <div className="space-y-8">
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="visible">
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <FontAwesomeIcon icon={faCertificate} className="text-indigo-600" /> License & Certification
              </h3>
              <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-4 h-4 rounded-full ${user.isLicensed ? "bg-indigo-600" : "bg-amber-500"}`}
                      ></div>
                      <span>{user.isLicensed ? "Licensed Professional" : "Not Licensed"}</span>
                    </div>
                  </div>
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.1 }}>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <FontAwesomeIcon icon={faClock} className="text-indigo-600" /> Availability
              </h3>
              <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
            ...
            <motion.div variants={cardVariants} initial="hidden" animate="visible" transition={{ delay: 0.2 }}>
              <h3 className="text-xl font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <FontAwesomeIcon icon={faMoneyBillWave} className="text-indigo-600" /> Pricing & Payment
              </h3>
              <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
      ...
      case "documents":
        return (
          <motion.div variants={cardVariants} initial="hidden" animate="visible">
            <h3 className="text-xl font-semibold text-gray-800 mb-6 flex items-center gap-2">
              <FontAwesomeIcon icon={faFileAlt} className="text-indigo-600" /> Professional Documents
            </h3>
            <div className="bg-gradient-to-br from-white to-indigo-50 p-6 rounded-2xl shadow-sm border border-indigo-100">
              {user.documents && Object.keys(user.documents).length > 0 ? (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    return fileId ? (
                      <motion.button
                        key={type}
                        onClick={() => handleDocumentClick(fileId, label)}
                        className="flex items-center gap-4 p-4 bg-white rounded-xl border border-indigo-200 hover:bg-indigo-50 hover:shadow-md transition-all duration-300 text-left w-full"
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.98 }}
                      >
                        ...
                        {downloading === fileId ? (
                          <RotatingLines strokeColor="#4f46e5" strokeWidth="5" animationDuration="0.75" width="20" visible={true} />
                        ) : (
                          <FontAwesomeIcon icon={faEye} className="text-indigo-600 text-lg" />
                        )}
                      </motion.button>
                    ) : null;
                  })}
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-indigo-50 py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        ...
        >
          <div className="md:flex">
            {/* Profile Picture & Basic Info */}
            <div className="md:w-1/3 p-8 bg-gradient-to-br from-indigo-600 to-indigo-700 text-white flex flex-col items-center">
              <div className="relative mb-6">
                {profilePictureUrl ? (
                  <motion.img
                    src={profilePictureUrl}
                  ...
                  <div className="w-40 h-40 rounded-full bg-indigo-500 flex items-center justify-center shadow-lg">
                    <FontAwesomeIcon icon={faUser} className="text-white text-6xl" />
                  </div>
                )}
                {user.isLicensed && (
              ...
              <motion.p
                className="text-indigo-100 text-center mb-6"
                initial={{ y: 10, opacity: 0 }}
                animate={{ y: 0, opacity: 1 }}
                transition={{ delay: 0.4, duration: 0.5 }}
              >
              ...
              <div className="w-full space-y-4">
                <motion.div
                  ...
                  transition={{ delay: 0.5, duration: 0.5 }}
                >
                  <FontAwesomeIcon icon={faEnvelope} className="text-indigo-200" />
                  <span className="text-indigo-50">{user.email || "N/A"}</span>
                </motion.div>
                <motion.div
                  className="flex items-center gap-3"
                  initial={{ x: -10, opacity: 0 }}
                  ...
                  transition={{ delay: 0.6, duration: 0.5 }}
                >
                  <FontAwesomeIcon icon={faPhone} className="text-indigo-200" />
                  <span className="text-indigo-50">{user.phoneNumber || "N/A"}</span>
                </motion.div>
                {user.yearsOfExperience && (
                  <motion.div
                    className="flex items-center gap-3"
                    ...
                    transition={{ delay: 0.7, duration: 0.5 }}
                  >
                    <FontAwesomeIcon icon={faBriefcase} className="text-indigo-200" />
                    <span className="text-indigo-50">{user.yearsOfExperience} years experience</span>
                  </motion.div>
                )}
              </div>
              ...
              <motion.button
                onClick={logoutUser}
                className="mt-8 w-full bg-white text-indigo-700 py-3 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-50 transition-all duration-300 shadow-md font-medium"
                whileHover={{ y: -2 }}
                whileTap={{ scale: 0.98 }}
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
            ...
            <div className="md:w-2/3 p-8">
              ...
              >
                <button
                  className={`px-4 py-2 font-medium text-sm md:text-base flex items-center gap-2 ${activeTab === "overview" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-500 hover:text-indigo-500"}`}
                  onClick={() => setActiveTab("overview")}
                >
                  <FontAwesomeIcon icon={faUser} /> Overview
                </button>
                <button
                  className={`px-4 py-2 font-medium text-sm md:text-base flex items-center gap-2 ${activeTab === "professional" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-500 hover:text-indigo-500"}`}
                  onClick={() => setActiveTab("professional")}
                >
                  <FontAwesomeIcon icon={faBriefcase} /> Professional
                </button>
                <button
                  className={`px-4 py-2 font-medium text-sm md:text-base flex items-center gap-2 ${activeTab === "documents" ? "text-indigo-600 border-b-2 border-indigo-600" : "text-gray-500 hover:text-indigo-500"}`}
                  onClick={() => setActiveTab("documents")}
                >
                  <FontAwesomeIcon icon={faFileAlt} /> Documents
                </button>
