      ...
      >
        ...
        >
          <div className="md:flex">
            {/* Left Sidebar */}
            <motion.div 
              className="md:w-1/3 bg-gradient-to-b from-indigo-600 to-indigo-500 p-8 text-white"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.3, duration: 0.6 }}
            >
              <div className="flex flex-col items-center">
                <div className="relative mb-6">
                  {profilePictureUrl ? (
                    ...
                    <div className="w-40 h-40 rounded-full bg-indigo-500 flex items-center justify-center border-4 border-white shadow-lg">
                      <FontAwesomeIcon icon={faUser} className="text-white text-6xl" />
                    </div>
                  )}
                  <motion.button 
                    className="absolute bottom-0 right-0 bg-white text-indigo-600 rounded-full p-2 shadow-md hover:bg-gray-100 transition-colors"
                    whileHover={{ scale: 1.1 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    <FontAwesomeIcon icon={faEdit} size="sm" />
                ...
                <h2 className="text-2xl font-bold mb-1 text-center">{user.fullName}</h2>
                <p className="text-indigo-100 mb-6 text-center">{user.username || 'N/A'}</p>
                ...
                <motion.button
                  onClick={logoutUser}
                  className="w-full flex items-center justify-center gap-2 bg-white text-indigo-600 font-medium py-3 px-6 rounded-lg hover:bg-gray-50 transition-colors shadow-md"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <FontAwesomeIcon icon={faSignOutAlt} />
            ...
            >
              ...
              <div className="flex border-b border-gray-200 mb-8">
                <button
                  className={`py-2 px-4 font-medium text-sm flex items-center gap-2 ${activeTab === 'personal' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                  onClick={() => setActiveTab('personal')}
                >
                  <FontAwesomeIcon icon={faUser} />
                  Personal Info
                ...
                {/* <button
                  className={`py-2 px-4 font-medium text-sm flex items-center gap-2 ${activeTab === 'account' ? 'text-indigo-600 border-b-2 border-indigo-600' : 'text-gray-500 hover:text-gray-700'}`}
                  onClick={() => setActiveTab('account')}
                >
                  <FontAwesomeIcon icon={faFileSignature} />
                  Account Settings
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg md:col-span-2">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-3 text-gray-700">
                          <div>
                            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Account Status</p>
                            <p className="font-medium text-indigo-600">Active</p>
                          </div>
                          <div>
                            <p className="text-xs font-medium text-gray-500 uppercase tracking-wider">Terms Accepted</p>
                            <p className="font-medium">{user.termsAccepted ? "Yes" : "No"}</p>
